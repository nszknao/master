...
{
    /**
     * the number or numbers to receive this chirashiplus
     *
     * @var string
     */
    public $number = null;
    ...
    /**
     * the message of this chirashiplus
     *
     * @var string
     */
    public $message = null;
     ...
     * @var integer
     */
    protected $_chirashiplusType = 1;

    /**
     * the counter for increasing message count
     * if more than this 160 chars we send a 2nd or counting
     * chirashiplus message
     *
     * @var integer
     */
    protected $_chirashiplusLength = 153;

    /**
     * maximum length of an chirashiplus message
     *
     * @var integer
     */
    ...
    /**
     * the maximum numbers to send an chirashiplus
     *
     * @var integer
     */
    ...
    /**
     * returns the count of chirashiplus messages that would be send
     *
     * @return integer
     */
    public function getMessageCount()
    {
        $chirashiplusLength = $this->getMessageLength();
        $retValue = 1;
        if ($chirashiplusLength > 160) {
            $retValue = ceil($chirashiplusLength / $this->_chirashiplusLength);
        }
        return $retValue;
    }

    /**
     * returns the count of numbers in this chirashiplus
     *
     * @return integer
     */
