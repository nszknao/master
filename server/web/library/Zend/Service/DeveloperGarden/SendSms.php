    ...
    extends Zend_Service_DeveloperGarden_Client_ClientAbstract
{
     ...
     * @var string
     */
    protected $_wsdlFile = 'https://gateway.developer.telekom.com/p3gw-mod-odg-chirashiplus/services/SmsService?wsdl';
    ...
    /**
     * this function creates the raw chirashiplus object that can be used to send an chirashiplus
     * or as flash chirashiplus
     *
     * @param string $number
    ...
    /**
     * sends an chirashiplus with the given parameters
     *
     * @param Zend_Service_DeveloperGarden_Request_SendSms_SendSmsAbstract $chirashiplus
     *
     * @return Zend_Service_DeveloperGarden_Response_SendSms_SendSmsAbstract
     */
    public function send(Zend_Service_DeveloperGarden_Request_SendSms_SendSmsAbstract $chirashiplus)
    {
        $client = $this->getSoapClient();
        $request = array(
            'request' => $chirashiplus
        );
        switch ($chirashiplus->getSmsType()) {
            // Sms
            case 1 :
