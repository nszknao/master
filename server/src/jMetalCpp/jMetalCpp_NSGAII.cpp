...
jMetalCpp_NSGAII::jMetalCpp_NSGAII(std::size_t pop, std::size_t iter)
:_popSize(pop),
_iterations(iter)
{}

jMetalCpp_NSGAII::~jMetalCpp_NSGAII()
{
 ...
 *                  April 2009)
 */
int jMetalCpp_NSGAII::run(MomentEq *meq) {
 ...
 */
std::vector<GAIndividual> jMetalCpp_NSGAII::getFinalPops()
{
    return _finalPops;
}
 ...
 */
void jMetalCpp_NSGAII::_saveArchive(SolutionSet &pop)
{
    std::size_t i, ii;
