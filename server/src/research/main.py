...
if __name__ == "__main__":
    ...
    #pop = ana.getSpecifiedKLPop(pop, sim, 500)
...
#    selectedPop = ana.getAroundSpecifiedSquareObjectValue(pop, 5.5, 6.5)
#    sPop = sorted(selectedPop, key=lambda x: cmn.klDivergence(cmn.createDispPdf(sim.dispx, x.detailPrm), sim.dispy))
