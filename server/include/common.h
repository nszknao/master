...
public:
    ...
    static void output3DIntoFile(const std::string, const std::vector<double> &, const std::vector<double> &, const std::vector<double> &);
    static void resize2DemensionalVector(std::vector< std::vector< double > > &, std::size_t, std::size_t);
    static void resize3DemensionalVector(std::vector< std::vector< std::vector<double> > > &, std::size_t, std::size_t, std::size_t);
